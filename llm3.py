...
def generate_feedback(performance_summary):
    ...
    for q_type, summary in performance_summary.items():
        ...
        if summary["incorrect"] > summary["correct"]:  # If incorrect answers are more than correct
            feedback += f"You are lagging in {q_type}. It might help to revisit the foundational concepts and practice more problems in this area.\n"
        elif accuracy < 50:
            feedback += f"You are struggling with {q_type}. Consider revisiting the concepts and practicing more questions.\n"
